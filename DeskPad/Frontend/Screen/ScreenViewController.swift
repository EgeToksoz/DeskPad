...
class ScreenViewController: SubscriberViewController<ScreenViewData>, NSWindowDelegate {
    ...
    override func viewDidLoad() {
        ...
        settings.modes = [
            // 32:9
            CGVirtualDisplayMode(width: 5120, height: 1440, refreshRate: 30),
            CGVirtualDisplayMode(width: 5120, height: 1440, refreshRate: 60),
            CGVirtualDisplayMode(width: 5120, height: 1440, refreshRate: 120),
            CGVirtualDisplayMode(width: 5120, height: 1440, refreshRate: 240),
            // 21:9 (239:100, 12:5)
            CGVirtualDisplayMode(width: 5120, height: 2160, refreshRate: 30),
            CGVirtualDisplayMode(width: 5120, height: 2160, refreshRate: 60),
            CGVirtualDisplayMode(width: 5120, height: 2160, refreshRate: 120),
            CGVirtualDisplayMode(width: 5120, height: 2160, refreshRate: 240),
            CGVirtualDisplayMode(width: 3840, height: 1600, refreshRate: 30),
            CGVirtualDisplayMode(width: 3840, height: 1600, refreshRate: 60),
            CGVirtualDisplayMode(width: 3840, height: 1600, refreshRate: 120),
            CGVirtualDisplayMode(width: 3840, height: 1600, refreshRate: 240),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 30),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 60),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 120),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 240),
            // 16:9
            CGVirtualDisplayMode(width: 3840, height: 2160, refreshRate: 30),
            CGVirtualDisplayMode(width: 3840, height: 2160, refreshRate: 60),
            CGVirtualDisplayMode(width: 3840, height: 2160, refreshRate: 120),
            CGVirtualDisplayMode(width: 3840, height: 2160, refreshRate: 240),
            CGVirtualDisplayMode(width: 2560, height: 1440, refreshRate: 30),
            CGVirtualDisplayMode(width: 2560, height: 1440, refreshRate: 60),
            CGVirtualDisplayMode(width: 2560, height: 1440, refreshRate: 120),
            CGVirtualDisplayMode(width: 2560, height: 1440, refreshRate: 240),
            ...
            CGVirtualDisplayMode(width: 1600, height: 900, refreshRate: 30),
            CGVirtualDisplayMode(width: 1600, height: 900, refreshRate: 60),
            CGVirtualDisplayMode(width: 1600, height: 900, refreshRate: 120),
            CGVirtualDisplayMode(width: 1600, height: 900, refreshRate: 240),
            CGVirtualDisplayMode(width: 1366, height: 768, refreshRate: 30),
            CGVirtualDisplayMode(width: 1366, height: 768, refreshRate: 60),
            CGVirtualDisplayMode(width: 1366, height: 768, refreshRate: 120),
            CGVirtualDisplayMode(width: 1366, height: 768, refreshRate: 240),
            CGVirtualDisplayMode(width: 1280, height: 720, refreshRate: 30),
            CGVirtualDisplayMode(width: 1280, height: 720, refreshRate: 60),
            CGVirtualDisplayMode(width: 1280, height: 720, refreshRate: 120),
            CGVirtualDisplayMode(width: 1280, height: 720, refreshRate: 240),
            // 16:10
            CGVirtualDisplayMode(width: 2560, height: 1600, refreshRate: 30),
            CGVirtualDisplayMode(width: 2560, height: 1600, refreshRate: 60),
            CGVirtualDisplayMode(width: 2560, height: 1600, refreshRate: 120),
            CGVirtualDisplayMode(width: 2560, height: 1600, refreshRate: 240),
            CGVirtualDisplayMode(width: 1920, height: 1200, refreshRate: 30),
            CGVirtualDisplayMode(width: 1920, height: 1200, refreshRate: 60),
            CGVirtualDisplayMode(width: 1920, height: 1200, refreshRate: 120),
            CGVirtualDisplayMode(width: 1920, height: 1200, refreshRate: 240),
            CGVirtualDisplayMode(width: 1680, height: 1050, refreshRate: 30),
            CGVirtualDisplayMode(width: 1680, height: 1050, refreshRate: 60),
            CGVirtualDisplayMode(width: 1680, height: 1050, refreshRate: 120),
            CGVirtualDisplayMode(width: 1680, height: 1050, refreshRate: 240),
            CGVirtualDisplayMode(width: 1440, height: 900, refreshRate: 30),
            CGVirtualDisplayMode(width: 1440, height: 900, refreshRate: 60),
            CGVirtualDisplayMode(width: 1440, height: 900, refreshRate: 120),
            CGVirtualDisplayMode(width: 1440, height: 900, refreshRate: 240),
            ...
            CGVirtualDisplayMode(width: 1280, height: 800, refreshRate: 240),
            // 21:9
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 30),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 60),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 120),
            CGVirtualDisplayMode(width: 3440, height: 1440, refreshRate: 240),
            CGVirtualDisplayMode(width: 1720, height: 720, refreshRate: 30),
            CGVirtualDisplayMode(width: 1720, height: 720, refreshRate: 60),
            CGVirtualDisplayMode(width: 1720, height: 720, refreshRate: 120),
            CGVirtualDisplayMode(width: 1720, height: 720, refreshRate: 240),
        ]
